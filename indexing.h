...
DECLARE_UNIQUE_INDEX(pg_bipointer_index, 9200, on pg_bipointer using btree (deputyclassid oid_ops));
#define BipointerIndexId 9200
...
DECLARE_UNIQUE_INDEX(pg_deputy_index, 9201, on pg_deputy using btree(deputyclassid oid_ops));
#define DeputyIndexId 9201

DECLARE_UNIQUE_INDEX(pg_deputytype_index, 9202, on pg_deputytype using btree(deputyclassid oid_ops));
#define DeputytypeIndexId 9202
...
DECLARE_UNIQUE_INDEX(pg_mapping_index, 9204, on pg_mapping using btree (classoid oid_ops));
#define MappingIndexId 9204
...
DECLARE_UNIQUE_INDEX(pg_switching_index, 9203, on pg_switching using btree (classoid oid_ops));
#define SwitchingIndexId 9203
